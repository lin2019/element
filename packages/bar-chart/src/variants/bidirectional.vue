...
import { BidirectionalBarSeriesBuilder } from '../core/SeriesBuilder';
...
export default {
  ...
  methods: {
    ...
    updateChartData() {
      ...
      const seriesBuilder = new BidirectionalBarSeriesBuilder(this.config, this.baseConfig, this.createGradientColor);
