...
import { StackBarSeriesBuilder } from '../core/SeriesBuilder';
...
export default {
  ...
  methods: {
    ...
    updateChartData() {
      ...
      const seriesBuilder = new StackBarSeriesBuilder(this.config, this.baseConfig, this.createGradientColor);
