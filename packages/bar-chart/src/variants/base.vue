...
import { BaseBarSeriesBuilder } from '../core/SeriesBuilder';
...
export default {
  ...
  methods: {
    ...
    updateChartData() {
      ...
      const seriesBuilder = new BaseBarSeriesBuilder(this.config, this.baseConfig, this.createGradientColor);
