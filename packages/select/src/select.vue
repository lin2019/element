...
<script type="text/babel">
  ...
  import scrollIntoView from 'yq-ui-code/src/utils/scroll-into-view';
  import { getValueByPath, valueEquals, isIE, isEdge } from 'yq-ui-code/src/utils/util';
  import NavigationMixin from './navigation-mixin';
  import { isKorean } from 'yq-ui-code/src/utils/shared';
