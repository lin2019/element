...
<el-row :gutter="12">
  <el-col :span="10" :xs="{span: 12}">
    ...
    >
      Brand Color<div class="value">#0555CE</div>
    <div 
      class="bg-color-sub"
...
<el-row :gutter="12">
  <el-col :span="6" :xs="{span: 12}">
    ...
    >Success<div class="value">#52C41A</div>
      <div 
        class="bg-color-sub"
      >
        <div 
  ...
  <el-col :span="6" :xs="{span: 12}">
    ...
    >Warning<div class="value">#FA9904</div>
      <div 
          class="bg-color-sub"
        >
        <div 
  ...
  <el-col :span="6" :xs="{span: 12}">
    ...
    >Danger<div class="value">#F03838</div>
      <div 
          class="bg-color-sub"
        >
        <div 
  ...
  <el-col :span="6" :xs="{span: 12}">
    ...
    >Info<div class="value">#868686</div>
      <div 
          class="bg-color-sub"
        >
        <div 
